        ...
        <div class="d-flex flex-column align-items-center">
            <div class="d-flex justify-content-end w-100">
                <form class="search-courses d-flex"
                      ...
                      method="get">
                    <input class="form-control me-2" name="search" placeholder="Enter course name" required>
            ...
            <c:forEach items="${requestScope.courses}" var="course">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="fs-4 btn btn-outline-success">Learn more</a>
                    </div>
                </div>
            </c:forEach>
            <ctg:pagestag pagesCountAttribute="${requestScope.page_count}" searchLine="${requestScope.search_line}"/>
        </div>
    </div>
</div>
