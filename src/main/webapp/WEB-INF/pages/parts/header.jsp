...
<header class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="#">MuzShock</a>
            ...
            <div class="navbar-nav">
                ...
                <c:choose>
                    <c:when test="${sessionScope.user == null}">
                        <a class="nav-link " aria-current="page" href="#"><fmt:message key="header.signup" bundle="${ rb }" /></a>
                        <a href="${pageContext.request.contextPath}/controller?command=go_to_login_page" type="button" class="btn btn-success"><fmt:message key="header.login" bundle="${ rb }" /></a>
                    </c:when>
                    <c:when test="${sessionScope.user.role eq UserRole.STUDENT}">
                        <a class="nav-link " aria-current="page" href="#"><fmt:message key="header.profile" bundle="${ rb }" /></a>
                    </c:when>
