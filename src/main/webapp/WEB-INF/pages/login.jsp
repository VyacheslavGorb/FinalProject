...
<div class="login-outer ">
    <div class="login-inner d-flex flex-column p-4">
        <form class="d-flex flex-column" action="${pageContext.request.contextPath}/controller?command=login" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password" name="password" required pattern="[0-9a-zA-Z]{8,20}"
                       title="<fmt:message key="login_page.password_hint" bundle='${rb}'/>">
            </div>
            <button type="submit" class="btn btn-success mt-2"><fmt:message key="login_page.login_btn" bundle='${rb}'/></button>
            <button type="button" class="btn btn-outline-secondary mt-3"><fmt:message key="login_page.signup_btn" bundle='${rb}'/></button>
        </form>
    </div>
</div>
