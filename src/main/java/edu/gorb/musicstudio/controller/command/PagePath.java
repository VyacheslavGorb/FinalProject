...
public final class PagePath {
    ...
    public static final String TEACHER_INIT_PAGE_REDIRECT = "/controller?command=teacher_init";
    ...
    public static final String CHOOSE_LESSON_TIMEDATE_PAGE_REDIRECT = "/controller?command=choose_lesson_datetime_page&subscription_id=";
    ...
    public static final String MANAGE_COMMENTS = "WEB-INF/pages/admin/manage_comments.jsp";
    public static final String MANAGE_COMMENTS_REDIRECT = "/controller?command=manage_comments&course_id=";
